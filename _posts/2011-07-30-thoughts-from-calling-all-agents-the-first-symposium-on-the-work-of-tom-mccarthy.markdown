...
date: !binary |-
  MjAxMS0wNy0zMCAxNToyMToxNiArMDIwMA==
date_gmt: !binary |-
  MjAxMS0wNy0zMCAxNToyMToxNiArMDIwMA==
categories:
- Literature
...
- id: 6516
  ...
  date: !binary |-
    MjAxMS0wOC0wMyAyMTo1NTowMCArMDIwMA==
  date_gmt: !binary |-
    MjAxMS0wOC0wMyAyMTo1NTowMCArMDIwMA==
  content: ! 'An accurate write up and enjoyable read. It was an excellent event and
    I share your praise for Dennis'' organising. 
    Eric Langley''s paper was certainly the most amusing, it would have been interesting
    to hear McCarthy''s responses to the Tintin examples. 
    I''d have liked more discussion on Men in Space, are you aware of any interesting
    discussion/criticism of it? 
    Thanks. '
- id: 6517
  ...
  date: !binary |-
    MjAxMS0wOC0wNCAwNjo1NzowMCArMDIwMA==
  date_gmt: !binary |-
    MjAxMS0wOC0wNCAwNjo1NzowMCArMDIwMA==
  content: ! 'Hi Ben,
    Thanks for this. Although I haven''t sat down to do any serious research on this,
    I wasn''t able to find any critical material on Men in Space in a cursory sweep
    of the MLA database. I might have missed something, but looks like the edited
    collection might be the first to feature it, then.'
- id: 6522
  author: ben v
  author_email: ''
  author_url: http://twitter.com/bengubbins
  date: !binary |-
    MjAxMS0wOC0wNCAyMjo1NjowMCArMDIwMA==
  date_gmt: !binary |-
    MjAxMS0wOC0wNCAyMjo1NjowMCArMDIwMA==
  content: ! 'Cheers for checking. Looking fwd to reading the essays in the Gylphi
    Press publication. 
    Regards. '
