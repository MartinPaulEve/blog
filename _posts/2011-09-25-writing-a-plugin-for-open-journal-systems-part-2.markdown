...
date: !binary |-
  MjAxMS0wOS0yNSAxNTo1Mzo1NCArMDIwMA==
date_gmt: !binary |-
  MjAxMS0wOS0yNSAxNTo1Mzo1NCArMDIwMA==
categories:
- Technology
...
- id: 6572
  ...
  author_url: ''
  date: !binary |-
    MjAxMS0xMi0wMiAxMjoyMTowMCArMDEwMA==
  date_gmt: !binary |-
    MjAxMS0xMi0wMiAxMjoyMTowMCArMDEwMA==
...
- id: 6573
  ...
  date: !binary |-
    MjAxMS0xMi0wMiAxMjoyNDowMCArMDEwMA==
  date_gmt: !binary |-
    MjAxMS0xMi0wMiAxMjoyNDowMCArMDEwMA==
  content: ! 'Hi Armin,
    Progress is good, but slow. The basics now work; I am working on making sure that
    images are correctly embedded and prettifying the existing XSLT.'
