---
archive: https://wayback.archive-it.org/22123/20231101171300/https://eve.gd/2020/02/27/my-draft-response-to-the-ukri-oa-consultation
date: 2020-02-27
doi: https://doi.org/10.59348/egjw6-x6v48
roguescholar: https://rogue-scholar.org/records/xy1f6-6jd62
atproto: at://did:plc:hnpt7ns2lecdujegbi6qkqqm/site.standard.document/3mq7m6hpgzk2i
image:
  feature: oa.png
layout: post
...
take into account when defining research articles that will be in-scope of the OA policy for the REF-after-REF 2021?**
...
a. PIDs are important for the unique identification of content and the extraction of its metadata.
b. It would be helpful to have more information about what these openly licensed profiles will be. Crossref schema metadata is usually deposited at Crossref, not made openly available on the publisher platform.
c. Again, this is easy in JATS XML and in Crossref deposits via the AL tag, but it is not clear how this should be embedded in PDF and HTML files. More clarity on how precisely this machine readable information should be encoded is needed.
d. Preservation is important. How equivalence to Portcio or CLOCKSS is determined should be specified.
e. I disagree with this. It adds substantial publisher overhead (and costs) and is not well used except in data analytics projects that often misuse citation data for crude ends. Some types of reference – such as archival finds – are incredibly difficult accurately to encode as element-citations in JATS, rather than mixed-citations, which miss all the benefits.
f. This is a good idea.
g. ORCID is useful for contributor identification and should be included.
...
a. Academic monographs Agree
b. Book chapters Agree
c. Edited collections Agree
...
**Q49. Which statement best reflects your views on whether UKRI’s OA policy should require copyright and/or rights retention for in-scope monographs, book
