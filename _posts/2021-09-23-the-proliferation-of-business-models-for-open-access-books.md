...
One of the core ways that we can make open access for monographs equitable is by avoiding book processing charges. These charges scale badly. They are [not well distributed between institutions](http://doi.org/10.1629/uksg.392). They exclude those from outside funded projects and wealthy universities in the Global North. They do us no favours in a move towards an open-access world.

Hence, it is encouraging to see a raft of new models for OA books. There’s MIT Press’s D2O scheme, Cambridge University Press’s Flip it Open, the membership models of Open Book Publishers and punctum books. And, of course, the [Opening the Future model](https://www.openingthefuture.net/) that I have been working on at COPIM with the Central European University Press and Liverpool University Press.
