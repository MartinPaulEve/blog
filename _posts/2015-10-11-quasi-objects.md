...
In other words, on one side of this type of thinking lies the assertion that human beings project value structures upon objects and then believe these value characteristics to be natural (gender, for example). On the reverse side, though, the methods of the social sciences involve studying, measuring and determining how objects, as though free of social construction, influence people's behaviour (such as bicycle helmets). As Latour puts it: “In the first denunciation objects count for nothing; they are just there to be used as the white screen on to which society projects its cinema. But in the second, they are so powerful that they shape the human society, while the social construction of sciences that have produced them remains invisible”.<a href="#note2" id="intext2"><sup>2</sup></a>
