...
layout: post
title: Action Short of a Strike Must Recognize That 9-5 is Not Always Helpful
...
- date: '2018-03-19'
  ...
  type: WebPage
  url: https://twitter.com/UoK_UCU/status/975670991778144256
  isPartOf:
    name: X
    type: WebSite
---
...
For instance, [UCU Kent Branch](https://twitter.com/UoK_UCU/status/975670991778144256) said: "ASOS needs to be effective. All UCU members must observe ASOS with the greatest solidarity possible. Work 35hrs no more, no emails after 6, never on W.ends".
...
1. The chronically ill and disabled, including me. I spend [quite a lot of time in hospitals](https://www.martineve.com/2016/03/28/i-am-currently-off-work-having-suffered-cerebral-vasculitis-and-a-stroke/). These appointments are, by necessity, during the usual 9-5 hours. My employer allows me to attend these appointments, knowing that I will be making up the hours at other times. My working life would be very difficult without this.

2. Those with childcare (or other caring) responsibilities. Flexibility to collect children from school, to tend to them in emergency situations, and other times seems, to me, to require flexibility from an employer, particularly for single parents, I would imagine.

3. Those who work unconventional hours in the first place. Birkbeck, University of London, where I work, is the night university/college of the University of London. Our teaching doesn't _start_ until 6pm.
