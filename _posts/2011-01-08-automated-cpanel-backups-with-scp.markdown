...
date: !binary |-
  MjAxMS0wMS0wOCAwODo0MTozMiArMDEwMA==
date_gmt: !binary |-
  MjAxMS0wMS0wOCAwODo0MTozMiArMDEwMA==
categories:
- Technology
...
- id: 6115
  ...
  date: !binary |-
    MjAxMS0wMS0xNCAxNTowMDowOCArMDEwMA==
  date_gmt: !binary |-
    MjAxMS0wMS0xNCAxNTowMDowOCArMDEwMA==
...
- id: 6509
  ...
  author_url: ''
  date: !binary |-
    MjAxMS0wNy0yNSAxNDoyMDowMCArMDIwMA==
  date_gmt: !binary |-
    MjAxMS0wNy0yNSAxNDoyMDowMCArMDIwMA==
  content: ! 'Hi
    Thank you for the script. I tried to run it by it came up with error message:
    please check the host hostname.com and username and password)
    I can confirm that host, user name and password were all correct. I could run
...
- id: 6510
  ...
  date: !binary |-
    MjAxMS0wNy0yNSAxNDoyODowMCArMDIwMA==
  date_gmt: !binary |-
    MjAxMS0wNy0yNSAxNDoyODowMCArMDIwMA==
