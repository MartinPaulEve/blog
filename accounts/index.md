...
<span class="account-note">A model for sustainable open-access monographs. Designed for existing presses, with a backlist, to make their future publications openly accessible, without author fees. I designed and ran the model <a href="https://doi.org/10.5281/zenodo.6907707">with Tom Grady and others</a>. In use by Central European University Press, Liverpool University Press, Michigan State University Press, Boydell & Brewer, and Basler Afrika Bibliographien.</span></li>
